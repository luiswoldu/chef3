...
// Super minimal recipe - just title and image
const minimalRecipe = {
  title: "Beef Stir Fry",
  image: "https://images.unsplash.com/photo-1512058564366-18510be2db19?auto=format&fit=crop&w=1200&q=80"
};

async function addMinimalRecipe() {
  try {
    console.log('Inserting absolute minimal recipe...');
    ...
    if (error) {
      console.error('Error inserting minimal recipe:', error);
    } else {
      console.log('Minimal recipe added successfully:', data);
    }
  } catch (error) {
